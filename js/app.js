//obtener valores para ocultar el form
...
function createList() {
  ...
  function showCard() {
    ...
    function addTextLi() {
      ...
      //Dar focus al textarea
      card.focus();
      /*//ocultar textarea al dar click fuera
      liCard.addEventListener('click', hideAndChange);
      function hideAndChange() {
        liCard.setAttribute('class', 'hide');
        liAnchor.setAttribute('class', 'show');
      };*/
    };
  };
};
